...
var CountryScreen = function (_React$Component) {
    ...
    function CountryScreen() {
        ...
        return _possibleConstructorReturn(this, (CountryScreen.__proto__ || Object.getPrototypeOf(CountryScreen)).apply(this, arguments));
    }
    ...
    _createClass(CountryScreen, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: "country-screen" },
                React.createElement(Bar, null),
                React.createElement(CountryCard, { isoAlpha3Code: "IRN" })
            );
        }
    }]);
