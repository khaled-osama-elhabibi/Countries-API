    ...
    _createClass(ControlBar, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(Search, { respondToApp: this.props.respondToApp }),
                React.createElement(Filter, { respond: this.props.respond })
            );
        }
    }]);
            ...
            if (this.state.names != undefined) {
                listOfCount = this.state.names.map(function (elem, index) {
                    return React.createElement(SearchItem, {
                        ...
                        respondToApp: _this5.props.respondToApp
                    });
                });
            }
            return React.createElement(
                ...
                this.isSearchActive() ? React.createElement(
                    "ul",
                    { className: "control-bar__search__list" },
                    listOfCount
                ) : ""
            );
        }
    ...
    _createClass(Filter, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "button",
                    { onClick: this.onClickHandlerRegions, className: "control-bar__filter-btn" },
                    "Filter By Region",
                    React.createElement(
                        "span",
                ...
                React.createElement(
                    "ul",
                    { className: "control-bar__filter-list" },
                    React.createElement(
                        "li",
